...
namespace AiLib.Chat
{
	...
	public class Conversation
	{
		...
		/// <param name="model">Optionally specify the model to use for ChatGPT requests.  If not specified, used <paramref name="defaultChatRequestArgs"/>.Model or falls back to <see cref="AiLib.Model.Model.ChatGPTTurbo"/></param>
		...
		public Conversation(ChatEndpoint endpoint, Model.Model model = null, ChatRequest defaultChatRequestArgs = null)
		{
			RequestParameters = new ChatRequest(defaultChatRequestArgs);
			if (model != null)
				RequestParameters.Model = model;
			if (RequestParameters.Model == null)
				RequestParameters.Model = AiLib.Model.Model.ChatGPTTurbo;
