...
namespace AiLib.Moderation
{
	...
	public class ModerationRequest
	{
		...
		public ModerationRequest(string input, Model.Model model)
		{
			Model = model;
			this.Input = input;
		}
		...
		/// <param name="model">The model to use. You can use <see cref="ModelsEndpoint.GetModelsAsync()"/> to see all of your available models, or use a standard model like <see cref="Model.TextModerationLatest"/>.</param>
		public ModerationRequest(string[] inputs, Model.Model model)
		{
			Model = model;
			this.Inputs = inputs;
		}
		...
		{
			Model = AiLib.Model.Model.TextModerationLatest;
			this.Inputs = input;
		}
	}
}
